...
class MiniMaxM2ModelTest(CausalLMModelTest, unittest.TestCase):
    pipeline_model_mapping = (
        {
            "feature-extraction": MiniMaxM2Model,
            "text-classification": MiniMaxM2ForSequenceClassification,
            "token-classification": MiniMaxM2ForTokenClassification,
            "text-generation": MiniMaxM2ForCausalLM,
            "question-answering": MiniMaxM2ForQuestionAnswering,
        }
        if is_torch_available()
        else {}
    )
